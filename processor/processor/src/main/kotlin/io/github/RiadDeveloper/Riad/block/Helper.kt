package io.github.shreyashsaitwal.Riad.block
...
private object HelperSingleton {
    ...
    init {
        val classesDir = Paths.get(System.getenv("Riad_PROJECT_ROOT"), ".Riad", "build", "classes")
        val annotationsJar = Paths.get(System.getenv("Riad_ANNOTATIONS_JAR"))
        val runtimeJar = Paths.get(System.getenv("Riad_RUNTIME_JAR"))
